    ...
    >
      <div className="hero min-h-screen bg-base-100">
        <div className="hero-content flex-col lg:flex-row-reverse">
          <img
            src={projarray[3].screenshot}
            className="max-w-lg rounded-lg shadow-2xl"
            alt="tech blog homepage"
          />
          <div>
            <h1 className="text-2xl font-bold">{projarray[3].title}</h1>
            <p className="py-6">{projarray[3].description}</p>
            <button className="btn btn-base-200 m-5">
              <a href={projarray[3].deploylink}>take me there</a>
            </button>
            <button className="btn btn-base-200 m-5">
